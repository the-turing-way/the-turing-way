...
> Remember to add your image to the `figures` [folder](https://github.com/the-turing-way/the-turing-way/tree/main/book/en/figures) and use the correct path, else it will not be displayed.
