...
As both GitHub and GitLab are based on git, we recommend you familiarize yourself with [version contro/](/version_control/version_control.html) before continuing. 
