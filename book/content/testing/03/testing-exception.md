<a name="Testing_challenging_or_exceptional_cases"></a>
...
The random number seeds is a way of making things reliably random. However, a risk with tests that depend on random number seeds is they can be brittle. Say you have a function structured something like this:
```Python
def my_function()
