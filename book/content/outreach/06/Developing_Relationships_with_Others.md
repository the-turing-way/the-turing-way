...
<!-- TP: THe following section could be formatted better, maybe bullet pointed.-->
## How to do this
...
## To Whom to Talk
The list given below should serve as a jumping-off point from which to begin establishing links with communicators. It is by no means exhaustive and researchers should feel free to go beyond its limits or indeed bypass it entirely. However, it should serve to illustrate the breadth of communication platforms that can be leveraged for good scicomm. <!-- TP: Try not to use these kind of abbreviations. -->
...
- Charitable Organisations / Societies <!-- TP: Any other suggestions from ATI guys? -->
    - Research Software Engineer Society
    - Software Sustainability Institute
- Online Content Creators / Influencers
<!-- TP: Are these the correct people to reference? -->
    - Tom Scott
    - Veritasium
    - Smarter Every Day
- Popular Science Publications <!-- TP: Any other suggestions from ATI guys? -->
    - New Scientist
    - Physics World
    - IOP
    - IEEE
