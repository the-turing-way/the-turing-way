...
- [ ] Add the exact date, time, location (if any!) and choice of tool that will be used for communication
  - [ ] Use open source software to avoid inaccessibility
...
- [ ] Remind everyone to arrange a web-camera and microphone, or headsets
  - [ ] If possible, provide any hardware items that are preferred by the organisation
...
- [ ] Send a reminder with the links to the document and other important resources to all the participant a day in advance
...
- [ ] Introduce the chair and note-taker, and let the chair take over for the rest of the tasks
...
- [ ] Use breakout room whenever possible to ensure that people can connect with each other while discussing a mutually useful question or issues (more tips below)
- [ ] Aim to have a fair discussion, don’t fixate on one argument
- [ ] Note-takers should document important outcomes from every discussion
- [ ] Encourage everyone to help the note-taker in documenting correct information
...
- [ ] Send message periodically reminding everyone of how much time for discussion is left
  - [ ] Reminding them to move on to the next person if only one person has spoken so far in their Groups
...
- [ ] To make organising truly inclusive, include different stakeholders from the community, organisation, and members from the diverse background in the committee
- [ ] If the organising committee has members across different time zones, the event can be in a distributed manner
...
- [ ] Look for sponsorship early on is always a good idea
  - [ ] In the early phase, even though not all the information is sorted, use the official website to attract sponsors
- [ ] Decide how big should be your event based on the available resources (such as online communication tools, assigned budget of the event, size of your community)
...
- [ ] Allocate part of your budget for the participation support grant that can be requested by the applicants for the following support
  ...
  - [ ] Hardware or types of equipment for facilitating participation, such as headsets, microphones, webcams (create a list of hardware that can be funded by the support grant)
...
- [ ] Deadline for application for participation support grant (equipments and internet cost)
  - [ ] Include application for participation support grant in the registration (such as types of equipment for remote joining, internet cost, childcare)
...
- [ ] Use registration platform like [Eventbrite](https://www.eventbrite.com/) that stores data centrally and works on most browsers
...
- [ ] Provide clear explanations for the complicated questions to guide people to choose the correct answer/option
...
- [ ] Instead of having a live lightning talk and poster presentation, invite submission of the pre-recorded lightning talks and talks on posters that can be assembled in a gallery (for example, [YouTube](https://www.youtube.com/) playlists or locally hosted video browsers) that can be accessed by everyone
  - [ ] For poster sessions, invite poster submissions and create a gallery of posters online that can be browsed easily
    ...
    - Share links of the posters with their pre-recorded videos (or link to the video) in the shared document
  - [ ] Decide the length of the pre-recorded videos for lightning talks and posters (recommended length is 1.5-2 minutes)
...
- [ ] Invite volunteers from the community to chair for these sessions
- [ ] Share speaker and session guidelines with the selected participants
- [ ] Share guidelines and protocols with the session chairs
- [ ] Treat social events in your program as seriously as any other slot, discuss this and agree upon the highly voted social events that are right fits for your community (see options in the later section)
...
- [ ] Arrange a separate conference call(s) with the participants to answer their questions related to the event, and also use the collaborative notes to share main discussion points
...
- [ ] Use social media to engage with the community
  - [ ] Reach out them as frequently as possible during the decision-making process
- [ ] Use online stores to sell swags to allow people to buy them before or during the event     
...
- [ ] Note-takers should document important outcomes from every discussion
- [ ] Session lead encourage everyone to help the note-taker in documenting correct information
...
- [ ] Run an open question and answer round where anyone can ask questions to the presenters, remind everyone to keep their question and response short
...
- [ ] Remind everyone of the time in a regular interval
- [ ] At the end run an open question and answer round where anyone can ask questions to the presenters, remind everyone to keep their question and response short
  - [ ] Use shared document or sli.do for taking questions
- [ ] Keep the format informal and allow flexibility for participation   
...
- [ ] Host a loosely themed social event so that the participants know what to expect, most importantly keep the theme fun and informal
- [ ] Share the link of the shared notes from the session or a social event chat system to keep it informal (for example, Slack)
- [ ] Start with an informal ice breaker - allow everyone to introduce themselves
  - [ ] This can be run by creating random or themes Zoom rooms or Breakout rooms (see this (Tweet by Jason Williams](https://twitter.com/JasonWilliamsNY/status/1240716295227805700))
- [ ] Follow the "show, don't tell", such as visual artefacts in the session format as much as possible
  - [ ] This can be run by playing simple games that are not too hard to explain and can be played by multiple people (like Dungeon and Dragons, see [D&D beyond](https://twitter.com/DnDBeyond))
...
- [ ] Send feedback form to all the participants with the thank you email
