...
- ORCID is a long lasting unique identifier for you as a person, comparible to the personal identification number that your government issues to you.
...
- have all your outputs related to you, no matter if you change your name or your instute: your outputs stay attached to you! This way, you only have to enter the information once.
- to access or sign up to services, e.g. publisher requirements, funding management portals (ResearchFish), the CRIS (current research information system) system at your institute, the Zenodo repository, etc.
