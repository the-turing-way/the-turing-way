...
Every image file used in this book should be located in the directory `book/en/figures` of our [GitHub Repository](https://github.com/the-turing-way/the-turing-way/tree/main/book/figures).
