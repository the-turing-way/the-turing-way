...
The initial interaction and sustained engagement of personas in a project comprises a few key phases:
...
This process will not only help help the _The Turing Way_ team members in getting you onboarded, but we will be able to improve the community documents including the [README](https://github.com/alan-turing-institute/the-turing-way/blob/master/README.md) and [Contributing Guidelines](https://github.com/alan-turing-institute/the-turing-way/blob/master/CONTRIBUTING.md) to make it more relatable and usable for the wider community.
