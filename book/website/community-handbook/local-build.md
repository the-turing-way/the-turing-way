...
- Anaconda is package manager that can install Python, R, Julia etc. *Miniconda* is just a smaller package manager that by default installs a smaller set of packages which means in terms of dependencies there are less things to go wrong.
