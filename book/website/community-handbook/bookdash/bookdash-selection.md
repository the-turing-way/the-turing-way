...
- **Post-event Documents**: ensure the update of [contributors file](https://github.com/alan-turing-institute/the-turing-way/blob/master/contributors.md), help document the event report and update the Book Dash chapter online
