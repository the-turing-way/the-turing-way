...
* **Recommendation from project delivery team**: If the actions or projects related to the WG are not seen to be in line with *The Turing Way* project more broadly or if more time investment is expected from the project delivery team (including the Research Community Manager) to support the WG (due to reduced capacity or conflicting priorities in the project), the project delivery team may recommend pausing or sunsetting a project.
The WG may decide to pivot their scope or pause their work following their internal or a community voting process (such as via a public GitHub issue).
