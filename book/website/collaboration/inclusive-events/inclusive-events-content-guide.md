...
As recommended in the {ref}`Inclusive Events Communications Guide<cl-inclusive-events-comms-website>` section, it can be incredibly helpful to centralize information about your event in an online location such as a website. 
...
The [Web Accessibility Initiative](https://www.w3.org/WAI/) outlines 4 principles that provide guidance on how to ensure that websites and their content are accessible. 
...
This is discussed in more depth in the {ref}`Using Plain Language<cl-inclusive-events-comms-plain-language>` section of the {ref}`Inclusive Events Communication Guide<cl-inclusive-events-comms>`.
