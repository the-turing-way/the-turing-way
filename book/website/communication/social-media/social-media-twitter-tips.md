...
Below are general tips for starting to use Twitter for personal academic purposes. Some of the tips have been adapted from 'Practical tips for scientists using twitter' {cite:t}`Chabrol2021twitter`.
...
These terms are adapted from {cite:t}`Cheplygina2020twitter`.
