...
However, as with all research activities, outreach requires careful planning and resourcing, while researchers share a collective responsibility to combat the spread of misinformation and provide the public with an accurate representation of science.
...
One of the main goals of this chapter is to discuss the importance of outreach in the research cycle, both in the academia and industry, and this way change the general consensus of outreach from 'optional' to 'essential'.

Here are the direct links to the subchapters:
- {ref}`Motivation and Background<cm-outreach-motivation>`
