...
Journal articles, as opposed to [preprints](rr-open-access-preprints), have gone through the peer review process- the paper has been peer reviewed and modified by the author in response to the reviewer's suggestions, so these papers are seen to have added value. 
...
You can read more about preprints in the [](rr-open-access) chapter.
...
We see peer review as an important exercise in [](cl) not limited to a quality-safeguard procedure.
