...
- **Maintainer:** Contributors who are responsible for driving the vision and managing the organizational aspects of the project. They may also be authors or owners of the project.
- **Metadata:** Data used to describe other data. For example (35, 33, 27, 30, 33) is data but the units (miles per hour) and the fact that these are the speeds of cars on a certain stretch of road is metadata.
...
- **Open notebook:** The practice of making research notebooks openly available.
