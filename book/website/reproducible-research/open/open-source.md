...
* Checkable. Open-source projects allow the wider research community to read and test each others' code. This way, bugs can be found more quickly and results can be validated by other researchers. 
