...
PIDs are globally unique identifiers that resolve permanently to your research, solving the "link rot" problem where URLs break over time. See our [chapter on persistent identifiers](rr-rdm-pid) to understand how PIDs work and why they're essential for FAIR research.
