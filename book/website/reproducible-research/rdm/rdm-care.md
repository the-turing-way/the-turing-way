(rr-rdm-care)=
# CARE principles
Concerns about secondary use of data and limited opportunities for benefit-sharing for Indigenous Peoples have led to the development of the CARE principles, which were published first in 2020 ([Carroll et al. 2020](https://doi.org/10.5334/dsj-2020-043)). The pervasive bias across data ecosystems, institutions and communities indicate the importance of addressing inequities at multiple levels. 
...
The genomic ([Carroll et al. 2022](https://doi.org/10.3389/fgene.2022.1052620)), as well as the ecology/biodiversity ([Jennings et al. 2023](https://doi.org/10.1038/s41559-023-02161-2)), research communities have worked on a framework for enhancing ethical genomic research with Indigenous communities.
