...
If possible use a repository that assigns a DOI (Digital Object Identifier), a type of persistent identifier that makes your data permanently findable and citable. DOIs solve the "link rot" problem by providing identifiers that resolve through a global infrastructure even as technology changes. See our [chapter on persistent identifiers](rr-rdm-pid) to learn how DOIs work through resolution services and why they're superior to regular URLs. Have a look in the {ref}`cm-citable` to see how to share and cite your data and other research objects. The {ref}`cm-citable-linking` section explains several options for linking your data and other research objects.
