...
* Built-in laboratory inventory management systems (LIMS) functionality for managing and documenting samples, reagents, and apparatus, or integration with seperate dedicated LIMS.
...
People will avoid using an ill-fitting tools that they perceive them to be getting in their way, especially scientists.
...
Conventionl software as a service (SaaS) platforms are highly verically integrated, the software development, hosting, and administration are package deal that you must take or leave as is.
