...
The manuscript can, for instance, be cited using Bibtex
...
The main purpose of this section, however, is to discuss the reproducible
...
that point to the state of the repository at a specific point in time
(using the git tagging feature).
...
This is leveraged to provide an Jupyter lab Integrated Development Environment
