...
In that regard, we define AI with respect to Open Source, using the Open Source Initiative [(OSI) definition](https://opensource.org/ai/open-source-ai-definition).
