...
Another common problem when creating VM or container images is 'packing more than you need'.
...
If a project you depend on is maintained by one person who gets burnt out and stops doing security updates, it does not matter that you have a technically robust trust architecture.
