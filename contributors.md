...
* GitHub: {githubuser}`xchen101`
* ORCID: [0000-0003-0207-2705](https://orcid.org/0000-0003-0207-2705)

* Short bio:
> Xiaoli Chen leads the Implementing FAIR Workflows project at DataCite, the goal of the project is to support researchers and research communities to effectively implement persistent identifier workflows across research project lifecycle, to ensure the FAIRness of outputs. She has a background in library and information science and has worked within the high-energy physics and neuroscience contexts. Xiaoli has contributed to The Turing Way book on the topic of persistent identifiers and FAIR research practices as part of the dissemination efforts for the [Implementing FAIR Workflows project](https://doi.org/10.54224/20568).

* Personal highlights:
> The FAIR Workflows project benefited greatly from the Turing Way Book as an invaluable resource to which we could point researchers and research communities to learn about the best practices around open sharing and FAIR research. It was a great experience to be part of the Book Dash and to contribute what we have learned from our project to the Turing Way community. The book dash experience was exceptional: well-organized, highly collaborative, and fun!
