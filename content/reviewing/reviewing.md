...
Code review provides an additional way of testing code quality. Instead of relying simply on [tests](../testing/testing.md#testing) which the original author puts together themselves, code review gets another programmer to look over the new code and assess it. The goal is to point out strengths and also potential areas of improvement.
...
This section will provide an overview of rationales, best practice, and likely workflows for code review. Some details refer specifically to github's code review functionality as a powerful and widely-used example of a formal code review system; however, equivalent and very similar systems are available elsewhere (e.g., [Gitlab](https://about.gitlab.com)), and even informal code review practices can also be very beneficial to a project.
...
Before requesting a review, be sure you've met all the obvious standards of the project you are contributing to. This means making sure:
...
- your code is not causing the tests in the main project to fail (many [continuous integration](#Continuous_integration) systems will test this automatically for you once you create the PR), and
...
- [ ] Make the changes, and note the changes are made against appropriate comments.
...
- [ ] Read the code, carefully.
  ...
  - [ ] Are that logic and approach sound?
