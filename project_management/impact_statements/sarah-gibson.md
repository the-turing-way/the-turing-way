...
My role in The Turing Way project was providing technical support for reproducible computational environments using [Binder](https://mybinder.readthedocs.io/en/latest/) and [BinderHub](https://binderhub.readthedocs.io/en/latest/index.html).
I worked on deploying BinderHub to the Microsoft Azure Cloud platform and improving the documentation around this to make it easier for others to deploy their own BinderHubs to Azure.

I have deployed two BinderHubs to Azure at The Alan Turing Institute.
Hub23 is an internal BinderHub for use amongst the Research Engineering and Academic teams and it authenticates users using a white-listed GitHub organisation.
...
I have written and presented workshops on using Binder for research reproducibility and deploying BinderHub as a service for RSEs and SysAdmins.
...
Providing an internal BinderHub as a service within The Alan Turing Institute will also make facilitating reproducible workflows easier for our researchers.
...
I am proud that I was able to deploy multiple BinderHubs over the course of the project and was invited to join the Binder team as a result of my contributions.
