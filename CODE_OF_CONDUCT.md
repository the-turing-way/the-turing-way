...
- Keep conversations open and inclusive. While some communications may require it, aim to avoid direct messaging (DMs) when discussing project-related topics, as this can limit collaboration and transparency with others. Instead, use public channels or threads to encourage participation and maintain open communication among community members.
